...
def cum_sum_in_call_count(df_nodes):
    ...
    plt.ylabel('cumulated  in call count')
    plt.xlabel('timestamp (hours)')
...
def cum_sum_out_call_count(df_nodes):
    ...
    plt.ylabel('cumulated out call count')
    plt.xlabel('timestamp (hours)')
...
def get_node_curves(df_temporal_features, query_hash):
    ...
    plt.grid()
    plt.title('Cumulated incoming call duration per hour in the period')
    ...
    plt.grid()
    plt.title('Cumulated outgoing call duration per hour in the period')
